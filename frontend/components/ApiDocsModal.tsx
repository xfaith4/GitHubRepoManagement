  ...
  },
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        notes: 'Each successful refinement is persisted per repo under output/roadmap-task-history/prompt-refinements/ and can be retrieved via GET /api/operations/prompt/history.',
      },
      {
        method: 'GET',
